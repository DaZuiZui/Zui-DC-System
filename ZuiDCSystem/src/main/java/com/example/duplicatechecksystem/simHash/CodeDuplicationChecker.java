...
public class CodeDuplicationChecker {
    ...
    public static void main(String[] args) {
        ...
        studentCodes.add("《水浒传》是中国古代四大名著之一，是一部以梁山泊起义为主线，讲述了宋江等梁山好汉的英勇事迹和传奇故事的长篇小说。我在阅读《水浒传》后，深受其内容和人物形象的影响。下面是我对《水浒传》的一些读书心得。");
        studentCodes.add(" 首先，我被《水浒传》中丰富多彩的人物形象所吸引。小说中塑造了108位各具特色的英雄好汉，每个人物都有独特的性格和故事。从宋江的仁义正直，到李逵的勇猛无畏，再到武松的豪勇正直，每个人物都给人留下深刻的印象。通过他们的形象和命运，作者展现了人性的复杂性和社会的不公，使我对人性和社会现象有了更深入的思考。");
